...
export function PinsTab({ roomId, isActive, onJump, onJumped, canUnpin, onLightbox }: PinsTabProps) {
    const [busyId, setBusyId] = useState<string | null>(null);
    const pinnedQuery = useChatRoomPinnedMessages(roomId, isActive);
                            ...
                            <div className={styles.pinMeta}>
                                {avatar ? (
                                    ...
                                    <span className={styles.pinAvatarPlaceholder}>
                                        {clampChars(senderDisplayName(m), 1) || "?"}
                                    </span>
                                )}
